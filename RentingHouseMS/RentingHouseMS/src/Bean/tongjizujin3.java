...
public class tongjizujin3 {
	...
	public ResultSet tongjizujin41(){
		...
		//sqlf="SELECT COUNT(租金)  FROM 房屋信息表  WHERE 租金 BETWEEN 500 AND  999";
		//sqlf="SELECT COUNT(租金)  FROM 房屋信息表  WHERE 租金 BETWEEN 1000 AND  1499";
	    sqlf="SELECT COUNT(租金)  FROM 房屋信息表  WHERE 租金 BETWEEN 1500 AND  1999";
		try{
			// 注册 JDBC 驱动
